...
export async function generateMetadata({ searchParams }: PageProps): Promise<Metadata> {
  ...
  const title = isGerman
    ...
    : "Road and gravel bike maintenance in Munich";
  const description = isGerman
    ...
    : "Road and gravel bike maintenance in Munich-Maxvorstadt with personal advice, oil-to-wax conversion, part swaps, repairs and optional pickup.";
