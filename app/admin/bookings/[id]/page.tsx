...
export default async function BookingDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const bookingInfoColumns: Array<Array<{ label: string; value: React.ReactNode }>> = [
    ...
    [
      ...
      {
        label: "Zeitraum",
        value: `${booking.periodFrom} ${booking.pickupTime} – ${booking.periodTo} ${booking.dropoffTime}`,
      },
      ...
      <SidebarInset className="min-w-0 overflow-hidden">
        ...
        <div className="admin-page-surface bg-muted dark:bg-background">
          <main className="admin-main min-w-0 max-w-full overflow-x-hidden flex flex-1 flex-col gap-6 p-4 sm:p-8 lg:p-12">
            <div className="flex flex-col gap-3" data-admin-page-header>
              <Button
                nativeButton={false}
                variant="ghost"
                size="sm"
              ...
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div className="min-w-0">
                  ...
                  <div className="mt-2 flex flex-wrap items-center gap-2">
                    <Badge
                      variant={statusView.badge}
                      className={
                        booking.status === "inquiry_received"
                          ? "border-border bg-muted-foreground/15 text-foreground dark:bg-muted-foreground/25"
                          : undefined
                      }
                    >
                      {statusView.label}
                          ...
                          <React.Fragment key={label}>
                            ...
                            <Item variant="default" size="xs" className="border-0 px-0 py-0">
                              <ItemHeader>
                                ...
                                <ItemActions className="min-w-0 max-w-[70%] justify-end text-right font-semibold">
                      ...
                      return (
                        <div className="h-full rounded-xl border p-4" key={item.id}>
                          <div className="min-w-0">
                            ...
                            <p className="mt-1 font-medium">{displayedBikeName}</p>
