...
export default async function FixedAssetsPage() {
  ...
  const assets: FixedAssetRow[] = db
    ...
    .map((asset) => ({
      ...
      originalAcquisitionCostCents: asset.originalAcquisitionCostCents,
      originalUsefulLifeMonths: asset.originalUsefulLifeMonths,
      originalCondition: asset.originalCondition,
      privateUseType: asset.privateUseType,
      preEntryDepreciationCents: asset.preEntryDepreciationCents,
