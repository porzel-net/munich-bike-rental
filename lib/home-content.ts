...
export const translations = {
  ...
  en: {
    ...
    hero: {
      ...
      intro:
        "We are a personal road, gravel and e-road bike rental service in Munich-Maxvorstadt and Regensburg-Altstadt and rent out well-maintained endurance, gravel, all-round and aero bikes for training, weekend rides and longer tours. Instead of a mass rental, you get direct contact, honest advice and clear pricing.",
