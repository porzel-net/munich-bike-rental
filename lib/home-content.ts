...
export const translations = {
  de: {
    ...
    form: {
      ...
      equipment: "Ausrüstung",
      pedals: "Ich brauche Pedale (einmalig 5€)",
      ...
      computerMount: "Ich brauche eine Fahrradcomputerhalterung (einmalig 5€)",
      ...
      helmet: "Ich brauche einen Helm (einmalig 10€)",
      clothing: "Ich brauche Kleidung (Rennradhose + Rennradtrikot) (einmalig je 15€)",
      repairKit: "Reparaturset (inklusive)",
      glasses: "Rennradbrille (einmalig 10 €)",
  ...
  en: {
    ...
    form: {
      ...
      equipment: "Equipment",
      pedals: "I need pedals (one-time €5)",
      ...
      computerMount: "I need a bike computer mount (one-time €5)",
      ...
      helmet: "I need a helmet (one-time €10)",
      clothing: "I need clothing (bib shorts + road jersey) (one-time €15 each)",
      repairKit: "Repair kit (included)",
      glasses: "Road cycling glasses (one-time €10)",
